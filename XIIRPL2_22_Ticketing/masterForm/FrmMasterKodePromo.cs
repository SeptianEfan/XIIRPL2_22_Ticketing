...
namespace XIIRPL2_22_Ticketing.masterForm
{
    public partial class FrmMasterKodePromo : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                koneksi.conn.Open();
                String sql = "INSERT INTO tbl_kode_promo" + "(kode,berlaku_sampai,presentase_diskon,maksimum_diskon,deskripsi)" + "VALUES" + "('" + txtKodePromo.Text + "','" + txtBerlakuSampai.Text + "','" + txtPresentasiDiskon.Text + "','" + txtMaksimumDiskon.Text + "','" + txtDeskripsi + "')";
